...
function Hsk3flashcard() {
  ...
  const answers = [
    { text: datas[shuffle].options.correct, correct: true },
    { text: datas[shuffle].options.wrong[0],correct: false },
    { text: datas[shuffle].options.wrong[1], correct: false },
  ];
