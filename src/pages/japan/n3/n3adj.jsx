...
const adjs = maindata.filter(
  (i) =>
    i.type.toLocaleLowerCase() === "adjective" ||
    i.type.toLocaleLowerCase() === "な-adjective" ||
    i.type.toLocaleLowerCase() === "pre-noun adjectival"
);
export default function N3adj() {
  return (
    <>
      <div className="max-w-6xl mx-auto p-4">
        <div className="text-gray-700 text-center">
          <h1 className="text-gray-700 font-semibold">N3</h1>
        </div>
